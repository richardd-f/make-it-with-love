  ...
  return createPortal(
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-8">
      ...
      >
        ...
        {/* Left Side: Image (takes up more space) */}
        ...
        <div className="w-full md:w-2/5 p-8 md:p-10 flex flex-col bg-white overflow-y-auto">
          ...
          <div className="flex items-center gap-4 mb-8">
            <div className="w-16 h-16 rounded-full overflow-hidden bg-[#ea7c9d]/20 relative border-2 border-[#f6e5c4] shrink-0 shadow-sm">
              <Image 
