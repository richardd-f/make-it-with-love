...
export const CourseCtaBox = ({ course }: { course: ICourseDetail }) => {
  ...
  return (
    <div className="w-full bg-[#32a569] rounded-[2rem] p-8 shadow-2xl sticky top-32 border-4 border-[#fffbe6] text-center flex flex-col gap-6 text-white overflow-hidden transform hover:-translate-y-1 transition-transform">
       ...
       <div className="text-center mt-2 opacity-80 text-sm flex items-center justify-center gap-2">
         <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M12 2L1 21h22L12 2zm0 3.99L19.53 19H4.47L12 5.99zM11 16h2v2h-2zm0-6h2v4h-2z" /></svg>
