  ...
  return (
    <div className="w-full bg-[#f6e5c4]/30 rounded-[2rem] p-8 sm:p-10 mb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
        {reviews.map(review => (
          <div key={review.id} className="bg-white p-8 rounded-3xl shadow-md border-2 border-white hover:border-[#f79d1c] transition-colors relative flex flex-col justify-between">
            {/* User Avatar & Name */}
      ...
      {isOwned && (
        <div className="w-full bg-white rounded-3xl p-8 sm:p-10 shadow-xl border-4 border-[#ea7c9d] relative overflow-hidden">
