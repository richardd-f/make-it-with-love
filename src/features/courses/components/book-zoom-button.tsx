...
export function BookZoomButton({ courseId, courseTitle }: { courseId: string; courseTitle: string }) {
  ...
  return (
    <button
      onClick={handleClick}
      className="w-full flex items-center justify-center gap-3 bg-[#ea7c9d] hover:bg-[#d86b8b] text-white font-bold text-2xl py-5 rounded-full shadow-lg hover:scale-105 transition-all font-family-papernotes uppercase tracking-widest"
    >
